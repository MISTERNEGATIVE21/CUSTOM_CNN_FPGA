...
void myproject_float(
    ...
    result_t layer91_out_ap[N_LAYER_91];

    myproject(global_in_ap,layer91_out_ap);

    nnet::convert_data<result_t, float, N_LAYER_91>(layer91_out_ap, layer91_out);
}

void myproject_double(
    double global_in[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1],
    double layer91_out[N_LAYER_91]
) {
    ...
    nnet::convert_data<result_t, double, N_LAYER_91>(layer91_out_ap, layer91_out);
}
}
